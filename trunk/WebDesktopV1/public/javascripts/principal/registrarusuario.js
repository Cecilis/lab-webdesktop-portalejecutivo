	...
	function grabar_comprador() {
       ...
       function verificarpassword(){
        ...
        function verificarcampos(){
      	 	if( Ext.getCmp ('cedula').getValue()=="" || Ext.getCmp('nombres').getValue()=="" ||
    			Ext.getCmp('apellidos').getValue()=="" || Ext.getCmp('telefono').getValue()==""||
  				Ext.getCmp('direccion').getValue()==""|| Ext.getCmp('fecha_nacimiento').getValue()== null ||
       			Ext.getCmp('sexo').getValue()== null || Ext.getCmp('nusuario').getValue()=="" ||
       			Ext.getCmp('password').getValue()=="" || Ext.getCmp('password2').getValue()=="" ||
           		Ext.getCmp('correo').getValue()== "" || Ext.getCmp('correo2').getValue()=="" ||
           		Ext.getCmp('imagen').getValue()== ""
            	)
       		{return false}
       		else {return true}
       }
